...
map.getView().fit([-8636541.084068, 4682416.600011, -8630734.171639, 4685016.391998], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Prince William County, VA Cattle Grazing Solar Analysis</h2>';
        return titleElement;
    })(),
